...
def render_long_display_panels(profit: float = 0.0,
    ...
    CX  = 48
    sc2 = tuple(max(25, c // 2) for c in sc)
    ...
    if connected:
        ...
        pc2 = tuple(max(22, c // 2) for c in pc)
        p3, d3 = panel(pc2)
        ...
        d3.text((CX, 38), "MT5",
                font=_font(24, True), fill=(255, 80, 90), anchor="mm")
        d3.text((CX, 62), "OFFLINE",
                font=_font(14),      fill=(200, 65, 75), anchor="mm")
        d3.text((CX, 82), "YALLA PIPS",
                font=_font(8),       fill=(100, 30, 35), anchor="mm")
...
def render_long_display(profit: float = 0.0,
    ...
    """Legacy — returns bottom panel (key 18) only."""
